                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="name" class="form-control" name="heading" value="{{ $post_data->heading }}">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="content"  cols="30" rows="10" class="form-control h_100 snote">{{ $post_data->content }}</textarea>
                                </div>
                                <div class="mb-4">
